package org.apache.shiro.captcha;
...
public class SimpleCaptcha {
	/**
	 * 默认验证码字符集，使用到Algerian字体，系统里没有的话需要安装字体，去掉了1,0,I,O,i,j,l,o几个容易混淆的字符
	 */
	private static final String DEFAULT_CAPTCHA_CODES = "23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghkmnpqrstuvwxyz";

	private static final ThreadLocalRandom RANDOM = ThreadLocalRandom.current();

	private String captchaCodes = DEFAULT_CAPTCHA_CODES;

	public void setCaptchaCodes(String captchaCodes) {
	...
	public String generateVerifyCode(int verifySize) {
		return generateVerifyCode(verifySize, captchaCodes);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < 5; i++) {
			...
			captcha.outputImage(w, h, file, verifyCode);
		}
	}
